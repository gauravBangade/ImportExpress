...
const Policy = () => {
  return (
    <Layout title={"policy-Import Express"}>
      <div className="privacy">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              importExpress.llc, Kothrud Pune.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Import Express, accessible from{" "}
              <a
                href="importexpress.com"
        ...
        <ul>
          <li>By email: GauravBangade@gmail.com</li>
        </ul>
      </div>
    </Layout>
  );
